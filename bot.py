...
SCHEDULE = [
    ...
    { "time": "20:50", "text": '📢  <a href="https://mostbet2.com/admin/app/paymentroute/list?filter%5BpaymentMethod%5D%5Bvalue%5D=rocket_gb">Выключить депозиты BDT_rocket_gb в админке</a> (либо попросить коллегу)\n✅<b>Уведомление в авто методы:</b>\n Выключили BDT_rocket_gb на сайте\n@jurxis @nii_med @gnxt_monitoring @Lika_mbt @Vikgmbt' },
